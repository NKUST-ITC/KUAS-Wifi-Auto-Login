...
public class Reason {
	...
	public static String dumpReason(int reason) {
		switch (reason) {
			...
			case 22:
			case 25:
				return "連接RADIUS伺服器時，發生了故障(" + reason + ")！";
			case 24:
			...
			case 31:
			case 32:
				return "連接POP3伺服器時，發生了故障(" + reason + ")！";
			case 33:
			case 34:
				return "POP3伺服器回應數據不正確(" + reason + ")！";
			case 40:
			case 42:
			case 43:
				return "連接LDAP伺服器時，發生了故障(" + reason + ")！";
			case 41:
