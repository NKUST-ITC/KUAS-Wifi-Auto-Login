...
public class WidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            //set default message
            changeMessage(remoteViews, context.getString(R.string.widget_default), context.getResources().getColor(R.color.white));
            //update widget
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (intent.getAction().equals(WIDGET_CLICK_ACTION)) {
            ...
            if (!isWidgetServiceRunning(WidgetService.class, context)) {
                changeMessage(remoteViews, context.getString(R.string.widget_connecting), context.getResources().getColor(R.color.md_teal_a700));
    ...
    private void widgetUpdate(Context context, AppWidgetManager appWidgetManager, RemoteViews remoteViews) {
